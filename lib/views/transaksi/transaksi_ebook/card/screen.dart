// lib/views/transaksi/transaksi_ebook/card/screen.dart
...
class TransaksiEbookCard extends StatelessWidget {
  final Transaksi transaksi;

  const TransaksiEbookCard({super.key, required this.transaksi});
