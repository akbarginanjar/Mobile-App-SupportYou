// // lib/services/transaksi_ebook_service.dart
...
// class TransaksiEbookService extends GetConnect {
//   Future<List<Transaksi>> getTransaksiEbookByStatus(String status) async {
//     print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
//     print('📤 GET Transaksi Ebook');
//     print('Status: $status');
...
//     final url = '${Base.url}v1/transaksi-online?konsumen_member_id=$memberId&show_bukti_tf=1&status=$status&view_as_invoice=1&start=0&length=20&transaction_type=barang';
...
//       Get.snackbar('Error Transaksi Ebook $status', 'Koneksi error: $e');
//       rethrow;
//     }
...
//       print('✅ Parsed ${transaksi.length} ebook transactions for status: $status');
//       print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
//       return transaksi;
//     } else {
//       String errorMessage;
